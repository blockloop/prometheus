...
func (*WriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{0}
}
...
func (*TSDBSnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{1}
}
...
func (*TSDBSnapshotResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{2}
}
...
func (*TSDBCleanTombstonesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{3}
}
...
func (*TSDBCleanTombstonesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{4}
}
...
func (*SeriesDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{5}
}
...
func (*SeriesDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpc_ce5db83e216acc4f, []int{6}
}
...
type AdminClient interface {
	...
	// GRPC WriteRequest
	RemoteWrite(ctx context.Context, opts ...grpc.CallOption) (Admin_RemoteWriteClient, error)
}
...
func (c *adminClient) RemoteWrite(ctx context.Context, opts ...grpc.CallOption) (Admin_RemoteWriteClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Admin_serviceDesc.Streams[0], "/prometheus.Admin/RemoteWrite", opts...)
	if err != nil {
		return nil, err
	}
	x := &adminRemoteWriteClient{stream}
	return x, nil
}

type Admin_RemoteWriteClient interface {
	Send(*WriteRequest) error
	CloseAndRecv() (*WriteResponse, error)
	grpc.ClientStream
}

type adminRemoteWriteClient struct {
	grpc.ClientStream
}

func (x *adminRemoteWriteClient) Send(m *WriteRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *adminRemoteWriteClient) CloseAndRecv() (*WriteResponse, error) {
...
type AdminServer interface {
	...
	// GRPC WriteRequest
	RemoteWrite(Admin_RemoteWriteServer) error
}
...
func _Admin_RemoteWrite_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AdminServer).RemoteWrite(&adminRemoteWriteServer{stream})
}

type Admin_RemoteWriteServer interface {
	SendAndClose(*WriteResponse) error
	Recv() (*WriteRequest, error)
	grpc.ServerStream
}

type adminRemoteWriteServer struct {
	grpc.ServerStream
}

func (x *adminRemoteWriteServer) SendAndClose(m *WriteResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *adminRemoteWriteServer) Recv() (*WriteRequest, error) {
	m := new(WriteRequest)
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Admin_RemoteWrite_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "rpc.proto",
...
func init() { proto.RegisterFile("rpc.proto", fileDescriptor_rpc_ce5db83e216acc4f) }

var fileDescriptor_rpc_ce5db83e216acc4f = []byte{
	// 513 bytes of a gzipped FileDescriptorProto
	,
}
