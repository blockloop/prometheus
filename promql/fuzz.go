...
import "github.com/digitalocean/prometheus/v2/pkg/textparse"
...
//
//     go-fuzz-build -func FuzzParseMetric -o FuzzParseMetric.zip github.com/digitalocean/prometheus/v2/promql
//
