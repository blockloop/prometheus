...
import "github.com/prometheus/prometheus/v3/pkg/textparse"
...
//
//     go-fuzz-build -func FuzzParseMetric -o FuzzParseMetric.zip github.com/prometheus/prometheus/v3/promql
//
